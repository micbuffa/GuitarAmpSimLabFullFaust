...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = std::tan(97.38937f / fConst0);
		fConst4 = 1.0f / fConst3;
		fConst5 = 1.0f / (fConst4 + 1.0f);
		fConst6 = 0.025f / fConst3;
		fConst7 = 1.0f / std::tan(270.17697f / fConst0);
		fConst8 = 1.0f / (fConst7 + 1.0f);
		fConst9 = 1.0f - fConst7;
		fConst10 = ftbl0mydspSIG0[2000];
		fConst11 = ftbl0mydspSIG0[0];
		fConst12 = 1.0f - fConst4;
		fConst13 = ftbl1mydspSIG1[2000];
		fConst14 = ftbl1mydspSIG1[0];
		fConst15 = ftbl2mydspSIG2[2000];
		fConst16 = ftbl2mydspSIG2[0];
		fConst17 = ftbl3mydspSIG3[2000];
		fConst18 = ftbl3mydspSIG3[0];
		fConst19 = 0.05f / fConst3;
		fConst20 = ftbl4mydspSIG4[2000];
		fConst21 = ftbl4mydspSIG4[0];
		fConst22 = ftbl5mydspSIG5[2000];
		fConst23 = ftbl5mydspSIG5[0];
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Input Volume", &fHslider1, FAUSTFLOAT(-6.0f), FAUSTFLOAT(-2e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("Output gain", &fHslider0, FAUSTFLOAT(7.0f), FAUSTFLOAT(-2e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fEntry0, "style", "menu{'12AX7':0;'12AT7':1;'12AU7':2;'6V6':3;'6DJ8':4;'6C16':5}");
		ui_interface->addNumEntry("Stage 1 Tube", &fEntry0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(5.0f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 0.001f * std::pow(1e+01f, 0.05f * static_cast<float>(fHslider0));
		float fSlow2 = static_cast<float>(fEntry0);
		int iSlow3 = fSlow2 >= 3.0f;
		int iSlow4 = fSlow2 >= 2.0f;
		int iSlow5 = fSlow2 >= 1.0f;
		float fSlow6 = 0.001f * std::pow(1e+01f, 0.05f * static_cast<float>(fHslider1));
		int iSlow7 = fSlow2 >= 5.0f;
		int iSlow8 = fSlow2 >= 4.0f;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec3[0] = 0.999f * fRec3[1] + 0.001f;
			fRec4[0] = 0.999f * fRec4[1] + 0.001f;
			fRec8[0] = fConst8 * (0.027f * (fRec7[1] + fRec7[2]) - fConst9 * fRec8[1]);
			fRec10[0] = fSlow6 + 0.999f * fRec10[1];
			float fTemp4 = fTemp0 * fRec10[0] * fTemp3;
			fRec9[0] = std::max<float>(fConst2 * fRec9[1], std::fabs(fTemp4));
			fHbargraph0 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec9[0])));
			float fTemp5 = fTemp4;
			float fTemp6 = 2e+02f * (fRec8[0] + fTemp5 + 3.418344f);
			int iTemp7 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp6)));
			float fTemp8 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp6 - static_cast<float>(iTemp7)));
			fRec7[0] = ((fTemp6 < 0.0f) ? fConst11 : ((fTemp6 >= 2e+03f) ? fConst10 : ftbl0mydspSIG0[iTemp7] * (1.0f - fTemp8) + fTemp8 * ftbl0mydspSIG0[iTemp7 + 1])) + -191.42015f;
			fRec6[0] = fConst5 * (fConst6 * (fRec7[0] - fRec7[1]) - fConst12 * fRec6[1]);
			fRec13[0] = fConst8 * (0.027f * (fRec12[1] + fRec12[2]) - fConst9 * fRec13[1]);
			float fTemp9 = 2e+02f * (fRec13[0] + fTemp5 + 2.382247f);
			int iTemp10 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp9)));
			float fTemp11 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp9 - static_cast<float>(iTemp10)));
			fRec12[0] = ((fTemp9 < 0.0f) ? fConst14 : ((fTemp9 >= 2e+03f) ? fConst13 : ftbl1mydspSIG1[iTemp10] * (1.0f - fTemp11) + fTemp11 * ftbl1mydspSIG1[iTemp10 + 1])) + -153.04619f;
			fRec11[0] = fConst5 * (fConst6 * (fRec12[0] - fRec12[1]) - fConst12 * fRec11[1]);
			fRec16[0] = fConst8 * (0.027f * (fRec15[1] + fRec15[2]) - fConst9 * fRec16[1]);
			float fTemp12 = 2e+02f * (fRec16[0] + fTemp5 + 1.281038f);
			int iTemp13 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp12)));
			float fTemp14 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp12 - static_cast<float>(iTemp13)));
			fRec15[0] = ((fTemp12 < 0.0f) ? fConst16 : ((fTemp12 >= 2e+03f) ? fConst15 : ftbl2mydspSIG2[iTemp13] * (1.0f - fTemp14) + fTemp14 * ftbl2mydspSIG2[iTemp13 + 1])) + -112.260666f;
			fRec14[0] = fConst5 * (fConst6 * (fRec15[0] - fRec15[1]) - fConst12 * fRec14[1]);
			fRec19[0] = fConst8 * (0.027f * (fRec18[1] + fRec18[2]) - fConst9 * fRec19[1]);
			float fTemp15 = 2e+02f * (fRec19[0] + fTemp5 + 2.70385f);
			int iTemp16 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp15)));
			float fTemp17 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp15 - static_cast<float>(iTemp16)));
			fRec18[0] = ((fTemp15 < 0.0f) ? fConst18 : ((fTemp15 >= 2e+03f) ? fConst17 : ftbl3mydspSIG3[iTemp16] * (1.0f - fTemp17) + fTemp17 * ftbl3mydspSIG3[iTemp16 + 1])) + -164.95741f;
			fRec17[0] = fConst5 * (fConst6 * (fRec18[0] - fRec18[1]) - fConst12 * fRec17[1]);
			fRec22[0] = fConst8 * (0.027f * (fRec21[1] + fRec21[2]) - fConst9 * fRec22[1]);
			float fTemp18 = 2e+02f * (fRec22[0] + fTemp5 + 3.136054f);
			int iTemp19 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp18)));
			float fTemp20 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp18 - static_cast<float>(iTemp19)));
			fRec21[0] = ((fTemp18 < 0.0f) ? fConst21 : ((fTemp18 >= 2e+03f) ? fConst20 : ftbl4mydspSIG4[iTemp19] * (1.0f - fTemp20) + fTemp20 * ftbl4mydspSIG4[iTemp19 + 1])) + -60.964962f;
			fRec20[0] = fConst5 * (fConst19 * (fRec21[0] - fRec21[1]) - fConst12 * fRec20[1]);
			fRec25[0] = fConst8 * (0.027f * (fRec24[1] + fRec24[2]) - fConst9 * fRec25[1]);
			float fTemp21 = 2e+02f * (fRec25[0] + fTemp5 + 2.078194f);
			int iTemp22 = std::max<int>(0, std::min<int>(1999, static_cast<int>(fTemp21)));
			float fTemp23 = std::max<float>(0.0f, std::min<float>(1.0f, fTemp21 - static_cast<float>(iTemp22)));
			fRec24[0] = ((fTemp21 < 0.0f) ? fConst23 : ((fTemp21 >= 2e+03f) ? fConst22 : ftbl5mydspSIG5[iTemp22] * (1.0f - fTemp23) + fTemp23 * ftbl5mydspSIG5[iTemp22 + 1])) + -141.78496f;
			fRec23[0] = fConst5 * (fConst6 * (fRec24[0] - fRec24[1]) - fConst12 * fRec23[1]);
			float fTemp24 = ((iSlow3) ? ((iSlow7) ? fRec23[0] : ((iSlow8) ? fRec20[0] : fRec17[0])) : ((iSlow4) ? fRec14[0] : ((iSlow5) ? fRec11[0] : fRec6[0])));
			fRec5[0] = std::max<float>(fConst2 * fRec5[1], std::fabs(fTemp24));
			fHbargraph1 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec5[0])));
			float fTemp25 = fRec2[0] * fRec3[0] * fRec4[0] * fTemp24;
			fRec1[0] = std::max<float>(fConst2 * fRec1[1], std::fabs(fTemp25));
			fHbargraph2 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec1[0])));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec0[0] + fTemp3 * fTemp25);
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
