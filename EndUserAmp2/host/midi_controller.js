...
const MIDI_STORAGE_KEY = 'wam-host-midi-mappings-v2';
...
async function populateAmpControls() {
    ...
    const ALLOWED_PARAMS = [
        { id: '/guitar_tube_amp_sim_100%_FAUST/Preamp_v6/Preamp__Controls/Input_Trim', label: 'INPUT' },
        { id: '/guitar_tube_amp_sim_100%_FAUST/Preamp_v6/Preamp__Controls/Gain', label: 'GAIN' },
